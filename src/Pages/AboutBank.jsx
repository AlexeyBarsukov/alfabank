        ...
        <div className={style.container}>
            ...
            <div className={styles.recommendations}>
                ...
                <span className={styles.subTitle}> Рекомендуйте продукты банка вашим знакомым <span style={{fontWeight: "bold"}}>по вашей
                    ...
                    Все интересующие вопросы, можно задать в  <a rel="noreferrer" target="_blank" href="https://t.me/+ApKJ4TR2Rv1lN2Qy" style={{fontWeight: 700, textDecoration: "none", color: "#C03A1B",}}>нашем телеграмм канале</a>
                </span>
